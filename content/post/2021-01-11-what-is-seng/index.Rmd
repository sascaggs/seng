...
knitr::include_graphics("/images/SENG 80s Fira.png", error = FALSE)
```
...
SENG is loosely structured as a learning community. We hold regular meetings that are oriented around one of two themes: **theory** and **methods**. Theoretically oriented meetings are casual happy hour style meetings that are used to discuss specific concepts that are relevant to social-ecological networks. For example, a theoretical meeting might focus on the concept of *modularity* or *connectivity* used to understand networks. The purpose of theoretical meetings is both to learn about network theory as well as consolidate a common language within our learning community. This common language is essential if we want to collaboratively develop new theoretical ideas use networks concepts as theoretical building blocks. Theoretical meetings may incorporate readings, but this is not a journal club, so we will only read as needed. If you are interested in the literature on networks, check our [Canon]() as a starting point. 
