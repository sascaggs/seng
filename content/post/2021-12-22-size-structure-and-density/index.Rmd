---
title: "Size dependent properties of undirected and directed networks"
...
```{r, echo=F, message=F, warning=F, fig.height=9.6, fig.width=8.4, fig.cap='A comparison of the degree distributions for three different size networks. Each line represents  levels of edge density.'}
d <- seq(0.01,0.99, length.out=11)
l <- list()
for(i in seq_along(d)) {
  l[[i]] <- network(10, directed = F, density = d[i])
