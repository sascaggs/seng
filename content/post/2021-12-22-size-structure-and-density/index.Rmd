...
net <- network(100, directed = F, density = sparsepoint(100, directed = F))
plot(net)

mean(geodist(net, count.paths = T, inf.replace = 0)$gdist)
```
