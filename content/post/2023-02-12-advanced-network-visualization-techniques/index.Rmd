...
grid %>% 
    ...
    ggtitle('Strenth = 0.1')
```
You must be very careful using arcs because they effect double the number of edges anywhere there is reciprocity, which can add unnecessary density to your graph.
